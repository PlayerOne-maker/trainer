...
class Monitor extends Component {
    ...
    constructor(props){
        super(props);
        this.state = {totalPrice: 0,orders: [],confirm: true ,msg: 'select product'};
...
confirmOrder(){
    ...
    axios.post("http://localhost:3001/orders", {orderedDate : new Date(), 
    totalPrice,orders}).then(res => {
        this.setState({totalPrice : 0 , orders: [],confirm: true ,msg: 'Save Order !!!'});
    })
    }
}
